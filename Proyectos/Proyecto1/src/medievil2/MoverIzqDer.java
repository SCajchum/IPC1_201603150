 ...
 * @author 22437
 */
public class MoverIzqDer extends Thread{
    ...
    public MoverIzqDer(String[][] matrizLogica, JButton[][] matrizCasillas, Jugador jugador, Vector<Vector<JLabel>> listaVidas, 
    ...
    public void run(){
        try {
                ...
                if (movimiento.equals(Der)){
                    if(!matrizLogica[fila][columna+1].equals(jugadorEspera)){
                        ...
                        if(random ==0){
                            ...
                            upDown.start();
                            this.listaVidas = upDown.getListaVidas();
                            this.jugador = upDown.getJugador();
                            this.matrizCasillas = upDown.getMatrizCasillas();
                            this.matrizLogica = upDown.getMatrizLogica();
                            a = cantidadMov;
                        }else{
                            MoverUpDown upDown = new MoverUpDown(matrizLogica,  matrizCasillas, jugador,
                                listaVidas, Aba, jugadorActual,(cantidadMov-a), tam);
                            upDown.start();
                            this.listaVidas = upDown.getListaVidas();
                            this.jugador = upDown.getJugador();
                            this.matrizCasillas = upDown.getMatrizCasillas();
            ...
            salirTablero(matrizCasillas[fila][columna].getIcon(), fila, columna);
